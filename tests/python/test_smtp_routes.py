...
from app.smtp_config import SmtpConfig, SmtpConfigUpdate, save_smtp_config
...
def test_get_smtp_settings_returns_null_when_unset() -> None:
    client = make_client()
    with patch("app.api.smtp_routes.enforce_host_guard", return_value=True):
